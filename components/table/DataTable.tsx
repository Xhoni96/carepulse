    ...
    <div className="z-10 w-full overflow-hidden rounded-lg border border-dark-400 shadow-lg">
      ...
      <div className="flex w-full items-center justify-between space-x-2 p-4">
        <Button
          ...
          className="border border-green-500 cursor-pointer text-white bg-green-500 hover:bg-green-500/90"
        >
        ...
        <Button
          ...
          className="border border-green-500 cursor-pointer bg-green-500 text-white hover:bg-green-500/90"
        >
